...
- Pour qu'un nom de domaine (exemple : monsite.fr) pointe vers une adresse IP (exemple : 192.168.1.16)
  il faut configurer le DNS (système qui fait le lien entre les noms et les adresses IP).
