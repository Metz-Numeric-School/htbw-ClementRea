...
- Créer un dossier qui nous servira de depot git bare, dans le dossier /var
- On rentre dendans et on fait l'init `git init --bare`
- Installer aapanel
- Le configuer en lançant une quick install en single webserver model
- On ajoute un site, en mettant comme nom de domaine l'adresse ip de la machine
...
- J'ai juste maintenant à executer `./deploy.sh 1.0.0` pour déployer le code en production
